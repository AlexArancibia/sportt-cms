...
import { Loader2, Save, CreditCard, Palette, LayoutGrid, Tag } from "lucide-react"
import { useToast } from "@/hooks/use-toast"
import { Badge } from "@/components/ui/badge"
import { motion } from "framer-motion"
import { CardSection, CardSectionMetadata, CardSectionStyles, CreateCardSectionDto, UpdateCardSectionDto } from "@/types/card"
    ...
    <form onSubmit={handleSubmit}>
      <div className="space-y-6">
        <div className="flex justify-between items-center">
          ...
          <JsonPreviewDialog title="Datos de la sección de tarjetas" data={jsonData} className="ml-2" />
        </div>
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="maxCards">Máximo de tarjetas</Label>
                    <Input
                      id="maxCards"
                      type="number"
              ...
              <CardContent className="space-y-6">
                ...
                {formData.layout === "carousel" && (
                  <div className="space-y-4 pt-4 border-t">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      <div className="space-y-2">
                        <Label htmlFor="carouselOptions.autoplay" className="block mb-2">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <Label htmlFor="carouselOptions.autoplay" className="cursor-pointer">
                            {formData.styles?.carouselOptions?.autoplay ? "Activado" : "Desactivado"}
                          </Label>
                        </div>
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="carouselOptions.loop" className="block mb-2">
                          Bucle infinito
                        </Label>
                        <div className="flex items-center space-x-2">
                          <Switch
                          ...
                          <Label htmlFor="carouselOptions.loop" className="cursor-pointer">
                            {formData.styles?.carouselOptions?.loop ? "Activado" : "Desactivado"}
                          </Label>
                        </div>
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="carouselOptions.arrows" className="block mb-2">
                          Mostrar flechas
                        </Label>
                        <div className="flex items-center space-x-2">
                          <Switch
                          ...
                          <Label htmlFor="carouselOptions.arrows" className="cursor-pointer">
                            {formData.styles?.carouselOptions?.arrows ? "Activado" : "Desactivado"}
                          </Label>
                        </div>
                      </div>
                      <div className="space-y-2">
                        <Label htmlFor="carouselOptions.dots" className="block mb-2">
                          Mostrar indicadores
                        </Label>
                        <div className="flex items-center space-x-2">
                          <Switch
                          ...
                          <Label htmlFor="carouselOptions.dots" className="cursor-pointer">
                            {formData.styles?.carouselOptions?.dots ? "Activado" : "Desactivado"}
                          </Label>
                        </div>
                      </div>
                    </div>
        ...
        <div className="flex justify-end gap-4">
          <Button type="button" variant="outline" onClick={() => router.push("/card-sections")} disabled={isSubmitting}>
            Cancelar
          </Button>
