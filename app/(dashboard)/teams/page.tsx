...
import { Plus, Search, Loader2, MoreHorizontal, Trash2, ChevronLeft, ChevronRight, Users, Pencil } from "lucide-react"
...
export default function TeamSectionsPage() {
  ...
  const renderMobileSectionCard = (section: TeamSection, index: number) => (
    <div
      key={section.id}
  ...
  const renderMobileEmptyState = () => (
    <div className="w-full px-4 py-6">
      <div className="flex flex-col items-center justify-center py-8 px-4 text-center bg-gray-50 dark:bg-gray-900/20 rounded-lg">
        ...
        <h3 className="text-base font-medium mb-1">No hay equipos</h3>
        <p className="text-muted-foreground mb-4 text-sm max-w-md">
          {!currentStore
            ? "No hay equipos para esta tienda."
            : searchTerm
              ...
              {isLoading ? (
                ...
                <div className="w-full">
                  ...
                  <div className="hidden sm:flex flex-col items-center justify-center py-16 px-4 text-center">
                    ...
                    <h3 className="text-lg font-medium mb-2">No hay equipos encontrados</h3>
      ...
      <AlertDialog open={isDeleteDialogOpen} onOpenChange={setIsDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta acción no se puede deshacer. Se eliminará permanentemente la sección y todos sus miembros asociados.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
      ...
      <AlertDialog open={isBulkDeleteDialogOpen} onOpenChange={setIsBulkDeleteDialogOpen}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Esta acción no se puede deshacer. Se eliminarán permanentemente las secciones seleccionadas y todos sus
              miembros asociados.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
