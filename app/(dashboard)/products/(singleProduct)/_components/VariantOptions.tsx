        ...
        <>
          <div className="space-y-4">
            ...
            {options.map((option, optionIndex) => (
              <div
                key={optionIndex}
                className=" rounded-lg border bg-muted/20 p-4 py-2 flex justify-between  "
              >
          ...
          {variants.length > 0 && (
            <div className="space-y-4">
              <div>
                <h4 className="text-sm font-medium">Tabla de Variaciónes</h4>
                <p className="text-sm text-muted-foreground">
          ...
          {options.length === 0 && (
            <div className="rounded-lg border border-dashed p-4">
              <p className="text-center text-sm text-muted-foreground">
                Añade atributos para crear variantes.
              </p>
            </div>
          )}
        </>
